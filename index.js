...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ Carregando ._. ⌛',
				success: '✔️ Funcionou kk ✔️',
				error: {
					stick: '❌ Eita..;-; ocorreu uma falha... triste ❌',
					Iv: '❌ Link inválido ;) ❌'
				},
				only: {
					group: '❌ Opss,este comando só pode ser usado em um grupo :/ ❌',
					ownerG: '❌ Eitaaa kkk só o dono do gp pode usar esse cmd kk ❌',
					ownerB: '❌ Kkk este comando só pode ser ocupado pelo Duduzin Gotoso ;) ❌',
					admin: '❌ Primeiro...Passe o admir para o bot seu BAKA!! ❌',
					Badmin: '❌ Vish;-; tô com preguiça de traduzir isso aqui :/ mas ocorreu um erro aí em ❌'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["556592812749@s.whatsapp.net"] // replace this with your number
